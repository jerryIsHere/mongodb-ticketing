...
export interface NotificationModel extends Model<INotification, {}, INotificationMethod> {

}
export const notificationSchema =
    new Schema<INotification, NotificationModel, INotificationMethod>({
...
export const notificationModel = model<INotification, NotificationModel>(singular_name, notificationSchema, collection_name)